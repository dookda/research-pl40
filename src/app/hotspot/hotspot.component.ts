...
export class HotspotComponent implements OnInit {
  ...
  loadmap() {
    ...
    // overlay map
    const w2Url = 'http://www2.cgistln.nu.ac.th/geoserver-fire/ows?';
    ...
    this.hotspot = L.tileLayer.wms(w2Url, {
      layers: 'activefire:modisgeo_lu, activefire:npp_viirsgeo_lu',
      format: 'image/png',
      transparent: true,
      zIndex: 5,
      // CQL_FILTER: 'prov_code=65'
    ...
    const overlayLayers = {
      ...
      'จุดความร้อน': this.hotspot.addTo(this.map)
    };
